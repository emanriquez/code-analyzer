...
@click.option('--snyk-token', envvar='SNYK_TOKEN', default=None, help='Snyk authentication token (e.g. SNYK_TOKEN env var or org-xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx)')
